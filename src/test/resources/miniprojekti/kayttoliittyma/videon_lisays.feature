...
Then the application responds with "Videovinkkiä ei lisätty, koska annettu otsikko oli tyhjä."

Scenario: User is unable to add a new video tip with empty url and valid title
Given Command "lisää video" is entered
When url "" and title "Google" are entered
Then the application responds with "Videovinkkiä ei lisätty, koska annettu url oli tyhjä."
...
Then the application responds with "Videovinkkiä ei lisätty, koska annettu otsikko oli pidempi kuin 100 merkkiä."
...
Then the application responds with "Videovinkkiä ei lisätty, koska annettu url oli pidempi kuin 50 merkkiä."
